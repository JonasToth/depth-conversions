...
inline int get_major_version() { return SENS_LOC_MAJOR; }
inline int get_minor_version() { return SENS_LOC_MINOR; }
inline int get_patch_version() { return SENS_LOC_PATCH; }
}  // namespace sens_loc
